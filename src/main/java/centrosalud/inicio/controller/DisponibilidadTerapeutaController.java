...
public class DisponibilidadTerapeutaController {
    ...
    public List<DisponibilidadTerapeuta> disponibilidadTerapeuta(@PathVariable Long id){
        
        List<DisponibilidadTerapeuta> disponibilidad = disponibilidadService.disponibilidadUnTerapeuta(id);
        return disponibilidad;
    }
}
